...
void Pwm_Init() {
    ...
    LPC_CT16B1->TCR = 2;
    LPC_CT16B1->PR = 479; // PreScaler value, at 48MHz, a PR value of 479 gives us a 100kHz clock
    ...
    LPC_CT16B1->MR1 = 50;     // Match Register 0 set to 50 counts, giving us 50% duty
